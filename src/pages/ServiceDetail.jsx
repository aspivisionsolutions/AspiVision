    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-28 relative z-10">
          <div className="max-w-4xl ml-5 md:ml-10 lg:ml-20 mt-20 mb-10">
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl opacity-90 max-w-3xl leading-relaxed mb-10"
            >
            ...
            >
              <Link 
                to="/contact" 
                className={`px-6 py-3 rounded-lg font-medium border-2 border-white bg-transparent hover:bg-white hover:text-purple-600 hover:bg-opacity-10 transition-colors flex items-center`}
              >
        ...
        <div className="absolute bottom-0 left-0 right-0 translate-y-1">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120" fill="white" className="w-full block">
      ...
      {/* Main Content */}
      <div className="container mx-auto px-6 sm:px-10 lg:px-20 py-12 md:py-20">
        <motion.div 
        ...
        >
          ...
          <div className="lg:col-span-2 space-y-8 md:space-y-12">
            ...
            >
              <div className="flex items-center mb-6">
                <div className={`p-3 rounded-lg ${service.color} mr-4`}>
                  <Fi.FiLayers className={`text-white w-6 h-6`} />
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {service.features.map((feature, index) => (
                  <motion.div
                    ...
                    className="flex items-start space-x-4 group p-4 hover:bg-gray-50 rounded-lg transition-all duration-300"
                  >
                    <div className={`p-2 rounded-full ${service.color} transition-all duration-300 group-hover:scale-110`}>
                      <Fi.FiCheck className={`text-white w-4 h-4`} />
                    </div>
                    <div>
            ...
            >
              <div className="flex items-center mb-6">
                <div className={`p-3 rounded-lg ${service.color} mr-4`}>
                  <Fi.FiAward className={`text-white w-6 h-6`} />
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {service.benefits.map((benefit, index) => (
                  <motion.div
                    ...
                    className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                  >
                    <div className="flex items-start space-x-4">
                      <div className={`p-2 rounded-full ${service.color}`}>
                        <Fi.FiStar className={`text-white w-4 h-4`} />
                      </div>
                      <div className="ml-3">
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center mb-6">
                <div className={`p-3 rounded-lg ${service.color} mr-4`}>
                  <Fi.FiCode className={`text-white w-6 h-6`} />
                </div>
              ...
              <div className="flex flex-wrap gap-3">
                {service.technologies.map((tech, index) => (
                  <motion.span
                    ...
                    className={`px-5 py-2.5 rounded-full text-sm font-medium ${service.color} text-white shadow-sm hover:shadow-md transition-all duration-300 cursor-default`}
                  >
                    {tech}
                  </motion.span>
                ))}
              ...
              <div className="mt-10">
                <h3 className="text-lg font-medium mb-5">Ready to get started?</h3>
                <Link 
                  to="/contact"
                  className={`w-full py-3 rounded-lg font-medium ${service.color} text-white ${colors.hover} transition-colors shadow-sm hover:shadow-md flex items-center justify-center`}
                >
            ...
            >
              <div className="flex items-center mb-6">
                <div className={`p-3 rounded-lg ${service.color} mr-4`}>
                  <Fi.FiHelpCircle className={`text-white w-6 h-6`} />
                </div>
              ...
              <div className="space-y-6">
                {service.faq.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      <summary className="flex cursor-pointer items-center justify-between px-6 py-4 bg-gray-50 hover:bg-gray-100 transition-colors">
                        <h3 className="font-medium text-gray-900">{item.question}</h3>
                        <span className={`ml-1.5 flex-shrink-0 rounded-full ${service.color} p-1.5 text-white sm:p-2`}>
                          <svg
        ...
        <motion.div
          ...
          className={`mt-16 rounded-2xl p-8 md:p-12 ${service.color} text-white text-center relative overflow-hidden`}
        >
          {/* Decorative elements */}
          <div className="absolute inset-0 opacity-10">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-xl opacity-90">Join hundreds of companies that have already benefited from our {service.title} service.</p>
            
            <div className="flex flex-wrap justify-center gap-6 mt-10">
              <Link 
                to="/contact" 
                className="px-8 py-4 bg-white text-gray-900 rounded-lg font-medium hover:bg-gray-100 transition-colors shadow-sm"
              >
                Get Started
              </Link>
            </div>
